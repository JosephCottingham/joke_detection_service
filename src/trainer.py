...
def run_fn(training_args: TrainerFnArgs):
    ...
    # Gather the passed traning and testing data 
    ...
    # Build model from function generated by "Model_Development.ipynb" notebook.
    model = build_model()

    # train the model, with the passed prams.
    model.fit(
        train_dataset,
    ...
    # Save teh model in serving directoy to be upload to s3 for general deployment.
